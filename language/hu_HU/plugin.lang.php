...
$lang['This plugin moves all your photos from <em>"galleries"</em> (added with the synchronization process) to <em>"upload"</em> and mark categories as virtual.'] = 'Ez a bővítmény valamennyi képet áthelyezi a <em>"galleries"</em> könyvtárból (beleértve a szinkronizációt) az  <em>"upload"</em> könyvtárba, és a kategóriákat virtuálisként jelöli meg.';
